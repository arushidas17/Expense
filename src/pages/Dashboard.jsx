...
import { CATEGORIES, INCOME, INITIAL_TRANSACTIONS, formatDate, formatINR } from "../constants";
        ...
        <div className="bg-white rounded-2xl border border-pink-100 p-5 shadow-sm">
          ...
          <div className="space-y-1">
            {recent.map(t => {
              ...
              return (
                <div key={t.id} className="flex items-center justify-between px-3 py-2.5 rounded-xl hover:bg-pink-50 transition-colors">
